...
Điều ngạc nhiên lớn nhất đối với tôi là khả năng phát hiện lỗi an toàn cực kỳ nhạy bén của mô hình sau khi qua căn chỉnh DPO. Dù nền tảng SFT trước đó liên tục vi phạm nghiêm trọng (thậm chí hướng dẫn cả các phương thức tự tử hay pha thuốc nổ cụ thể), chỉ sau một epoch huấn luyện DPO với 1000 cặp UltraFeedback, mô hình đã hoàn toàn thay đổi thái độ: từ chối vô cùng lịch sự, dứt khoát và cung cấp ngay lập tức các đường dây cứu hộ y tế.
